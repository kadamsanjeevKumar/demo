...
<head>
  <meta charset="UTF-8">
  <title>Post Ads Redirection</title>
...
<h1>Oops</h1>  
  <p>Posting feature is currently stopped by ADMIN. Will be back shortly<br> Thank you for your patience. <br>
    {{--<a href="/contact-us">Contact Admin</a> for more details.--}}
    </p>
  ...
  <script src="/assets/user/js/toastr.js"></script>
        ...
        $('#submitForm').click(function() {
          ...
          if(desc.trim() == ""){
            ...
            if(count == 0) {
              $.ajax({
                url: '/user/redirect/posting/error',
                type: 'POST',
                dataType: 'JSON',
