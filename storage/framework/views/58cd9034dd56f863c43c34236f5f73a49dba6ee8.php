...
<?php $__env->startSection('all_posts','active'); ?>
...
<?php $__env->startSection('page_content'); ?>
    <div style="display: block;" id="loadingDiv"></div>
    <p id="page_name" hidden data-name="local_count"></p>
    ...
    <div class="row">
        <div class="col s11 m12 l12" style="">
            <div class="col m12 l12"
                 style="background:#F9F9F9;position: sticky; padding:15px 10px; top:64px; z-index: 99">
                <a class="waves-effect waves-light btn modal-trigger change_cat" style="float: right;margin-left:20px;"
                   data-target="changeCategory" href="#changeCategory" title="Change category of multiple ads">Change
                    Post Category</a>
                <a class="waves-effect waves-light btn modal-trigger" style="float: right;" data-target="modal"
                   href="#modal" id="btn_date">Add Post Expiry Days</a>

                <h5 style="margin-bottom:15px; float: left;">LOCAL ADS</h5>
                <a id="delete_all" title="Delete ads"
                   style="cursor: pointer; margin: 4px 0px 0px 20px;background:#cc3e3e; float:left;"
                ...
                <div class="left m-l-18">
                    <div class="input-field col s12">
                        <select id="reg_user_drpdwn" name="reg_user_drpdwn">
                            ...
                            <option value="3" <?php if($post_type['type']==3): ?> <?php echo e('selected'); ?> <?php endif; ?>>Pending Posts</option>
                            <option value="2" <?php if($post_type['type']!=3): ?> <?php echo e('selected'); ?> <?php endif; ?>>All Posts</option>
                            <?php /*<option value="3" <?php if(isset($post_type['type']) && $post_type['type']==3): ?> <?php echo e('selected'); ?> <?php endif; ?>>Pending Posts</option>*/ ?>
                            <?php /*<option value="2" <?php if(isset($post_type['type']) && $post_type['type']!=3): ?> <?php echo e('selected'); ?> <?php endif; ?>>All Posts</option>*/ ?>
                        </select>
    ...
    <div id="changeCategory" class="modal" style="min-height: 350px;width: 45%">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="#!" class="waves-effect waves-light btn move_category"
                   style="margin-right:10px;background-color:#4caf50;">MOVE</a>
            </div>
        </div>
    </div>
...
<?php $__env->startSection('page_scripts'); ?>
    ...
    <script>
        // var type=2;
        <?php /*var type ='<?php echo e(isset($post_type['type'])); ?>';*/ ?>
        // alert(type);
        <?php /*var type='<?php echo e(isset($post_type['type'])?$post_type['type']:null); ?>';*/ ?>
        var type = '<?php echo e($post_type['type']); ?>';
        // alert(type);
        var oTable;
        $(document).ready(function () {
            drawTable();
            ...
            $(document.body).on('click','.ipModal',function(event){
                ...
                $('#ip_block_form input[name="ip_block"]').val(ip);
                console.log(ip);
                $.ajax({
                    url:"/admin/check/ip",
                    type:'post',
...
//                    }
            ...
            $('#bump_all').click(function () {
                swal({
                    title: "Are you sure you want to Bump All Expired ads(Local) from Begining.?",
                    text: "You won't be able to revert this!",
                    type: "warning",
                    showCancelButton: true,
                    confirmButtonColor: "#DD6B55",
                ...
                if (confirm("Are you sure You want to delete this ad?")) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.status == 'success') {
                                toastr.success(data.msg, {timeOut: 2000});
                                $(current_element).parent().prev().prev().prev().prev().html('<div class="chip" style="background-color:#ef5350 !important;' +
                                    'line-height: 16px !important;padding: 3px 12px;color: #fff;">Community removed</div>');
...
//                    $(document.body).find(':checkbox:checked').each(function (i, v) {
...
//                    console.log(id);
                        ...
                        $.ajax({
                            url: '/admin/move/wrong/multiple/category',
                            type: 'POST',
                            dataType: 'json',
                            data: formdata,
                            processData: false,
